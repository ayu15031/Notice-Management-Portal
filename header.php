		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <ul class="nav navbar-nav navbar-right menu-design">
				  ...
				  <li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">Student Login<span class="caret"></span></a>
						  <ul class="dropdown-menu">
							  <li><a href="login.php?data=3">Student</a></li>
							  <li><a href="login.php?data=4">Student Incharge</a></li>
						  </ul>
				  </li>
