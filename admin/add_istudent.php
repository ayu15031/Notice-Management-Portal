        ...
        foreach ($reader->getSheetIterator() as $sheet) {
            ...
            foreach ($sheet->getRowIterator() as $row) {
                ...
                if ($count > 1) { 
                   ...
                   $q="insert into student_login values('$id','$uname','$pass','$club','$name','$desig','$email')";
...
if(isset($_POST['submit'])){
		...
		$id=$_POST['enroll'];
		$des=$_POST['des'];
		$q="select * from istudent_login where id='$id'";
		$result = mysqli_query($con, $q);
		$num = mysqli_num_rows($result);
		if($num>0)
			$error="Student Incharge already added";
		...
		$q="insert into istudent_login values('$id', '$uname','$pass','$club','$name','$des','$email')";
		$result = mysqli_query($con, $q);
		$success="Student Incharge Added";
		}
		}
}
?>
      ...
      <div class="container">
        <div class="section-header">
		 ...
		 <div class="col-md-4">
		  ...
		  <p style="text-align:center; "><a target="_blank" href="istudent.xlsx">Get Format Of Excel File</a></p>
		 ...
		 <form method="post" style="margin-top:30px; margin-left:auto; margin-right:auto;">
				...
				<button type="submit" name="submit" class="btn btn-default">Add Student Incharge</button>
