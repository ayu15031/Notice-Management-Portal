		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <ul class="nav navbar-nav navbar-right menu-design">
				...
				<li class="active"><a href="view_all.php">View all</a></li>
...
<section>
      <div class="container">
        <div class="section-header">
          <h2>View notices sent by club</h2>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
								...
								if($sort=="sort_date"){
                                $data=mysqli_query($con,"SELECT * FROM notices WHERE club='$club' ORDER BY date DESC");
								}
								else if($sort=="sort_sent"){
									$data=mysqli_query($con,"SELECT * FROM notices WHERE club='$club' ORDER BY sent_by ASC");
								}
                                ...
                                while($arr=mysqli_fetch_assoc($data)):
                                   ...
                                   {  
                                    ...
                                    ?>
										...
										<td><a target="_blank" href="../admin/upload/<?php echo $arr['pdf_src']?>"><?php echo $arr['title']?></a></td>
