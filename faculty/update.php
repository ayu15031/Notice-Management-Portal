...
$success="";
	...
	if(isset($_POST['email'])){
		$des=$_POST['mail'];
				...
				$q2="update faculty_login set designation='$des' where email = '$email'";
				 mysqli_query($con, $q2);
				 $success="Designation changed successfully";
	}
      ...
      <div class="container">
        <div class="section-header">
		 ...
		 <form method="post" style="margin-top:30px; margin-left:auto; margin-right:auto;">
				...
				<input type="text" name="mail"  required="required" class="form-control" >
				</div>
