...
$success="";
	...
	if(isset($_POST['submit'])){
		$q1="select * from student_login where username = '$uname'";
		...
		if($old==$row1['password']){
			if($new1==$new2){
				$q2="update student_login set password='$new1' where username = '$uname'";
				 mysqli_query($con, $q2);
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <ul class="nav navbar-nav navbar-right menu-design">
                ...
                <li  class="actice"><a href="password.php">Change Password</a></li>
